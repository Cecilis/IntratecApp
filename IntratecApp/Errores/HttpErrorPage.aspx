<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HttpErrorPage.aspx.cs" Inherits="IntraTecApp.HttpErrorPage" %>
<!DOCTYPE HTML>
<html class="no-js">
...
<body>
<form id="frmErrorHTTP" runat="server">
    <div class="container ui-corner-all">
        <div class="content">
            <asp:Panel ID="pnlError" runat="server" CssClass="Panel Cabecera Titulos ui-state-default ui-corner-all" Width="100%">
                <asp:Label ID="lblError" runat="server" Text="Error HTTP" />
            </asp:Panel> 
