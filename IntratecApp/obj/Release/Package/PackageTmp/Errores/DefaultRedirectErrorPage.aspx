<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultRedirectErrorPage.aspx.cs" Inherits="IntraTecApp.DefaultRedirectErrorPage" %>
<!DOCTYPE HTML>
<html class="no-js">
...
<body>
    <form id="frmPaginaErrorPorDefecto" runat="server">
                ...
                <tr>
                    <td class="col100_100 CamposGrid">
                        ...
                        <asp:Label ID="exMessage" runat="server" Font-Bold="true" Font-Size="Large">
                            No hay una descripción disponible para el error.
                        </asp:Label>
                        <br />
                        <br />
                    </td>
